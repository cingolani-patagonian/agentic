...
<absolute path to codebase>/media/e2e/<adw_id>/<directory name based on test file name>/*.png
...
```json
{
  ...
  "screenshots": [
    "<absolute path to codebase>/media/e2e/<adw_id>/<test name>/01_<descriptive name>.png",
    "<absolute path to codebase>/media/e2e/<adw_id>/<test name>/02_<descriptive name>.png",
    "<absolute path to codebase>/media/e2e/<adw_id>/<test name>/03_<descriptive name>.png"
  ],
  "error": null
}
```